...
function drawBlades(rotationAngle, orbitAngle, orbitRadiusX, orbitRadiusY, orbitCenterX, orbitCenterY) {
  ...
  var x = Math.cos(orbitAngle) * orbitRadiusX[0][0] + Math.sin(orbitAngle) * orbitRadiusX[1][0] + orbitCenterX;
  var y = Math.cos(orbitAngle) * orbitRadiusY[0][0] + Math.sin(orbitAngle) * orbitRadiusY[1][0] + orbitCenterY;
...
function updateAnimation() {
  ...
  orbitAngle1 += 0.4; // Perubahan sudut untuk orbit
  
  rotationAngle2 += 0.01; // Rotasi searah jarum jam
  orbitAngle2 += 0.4; // Perubahan sudut untuk orbit berlawanan arah

  rotationAngle3 += 0.01; // Rotasi berlawanan arah jarum jam
  orbitAngle3 += 0.4; // Perubahan sudut untuk orbit

  rotationAngle4 += 0.01; // Rotasi berlawanan arah jarum jam
  orbitAngle4 += 0.4; // Perubahan sudut untuk orbit
...
function animate() {
  gl.clear(gl.COLOR_BUFFER_BIT);
  updateAnimation();
  drawBlades(rotationAngle1, orbitAngle1, [[0.5, 0.5], [0.5, 0.5]], [[-0.5, 0.5], [0, 0.5]], 0.0, 0.0);
  drawBlades(rotationAngle2, orbitAngle2, [[0.5, 0.5], [0.5, 0.5]], [[0, -0.5], [0.5, 0]], 0.0, 0.0);
  drawBlades(rotationAngle3, orbitAngle3, [[0.5, 0.5], [0.5, 0.5]], [[-0.1, -0.5], [0.1, 0.1]], 0.0, 0.0);
  drawBlades(rotationAngle4, orbitAngle4, [[0.1, -0.5], [0.1, 0.1]], [[-0.5, 0.5], [0.5, 0.5]], 0.0, 0.0);
